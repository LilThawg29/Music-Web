...
router.post("/create", authorizationToken, musicControllers.CREATE_MUSIC);
router.put(
  "/edit/:_id",
  upload.fields([{ name: "image_music", maxCount: 1 }]),
  authorizationToken,
  musicControllers.EDIT_MUSIC
);
router.get("/get-by-id/:_id", musicControllers.GET_BY_ID);
...
router.get(
  "/get-upload",
  authorizationToken,
  musicControllers.GET_MUSIC_ACCOUNT
);
router.delete("/delete-by-id", isAdmin, musicControllers.DELETE_BY_ID);
